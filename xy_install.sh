...
function get_emby_image() {
    ...
    case $cpu_arch in
    "x86_64" | *"amd64"*)
        emby_image="amilys/embyserver:latest"
        ;;
...
function user_select4() {
    ...
    if [[ "${f4_select}" == [127] ]]; then
        search_img="amilys/embyserver|amilys/embyserver"
        del_name="emby"
...
img_uninstall() {   
    ...
    img_order=()
    search_img="amilys/embyserver|amilys/embyserver|nyanmisaka/jellyfin|jellyfin/jellyfin"
    check_qnap
    # check_loop_support
